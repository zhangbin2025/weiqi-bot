...
export class WebBootstrap {
  ...
  static async init(options: WebBootstrapOptions): Promise<WebShellContext> {
    ...
    return { network, config, adapterFactory, rootContainer, createCache, favoriteService, gameHistoryStorage, readMarkService, sessionStorageService, createCacheStorage, proxyUrl };
  }
}
