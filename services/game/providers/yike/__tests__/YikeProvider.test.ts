...
describe('YikeProvider', () => {
  ...
  describe('基础信息', () => {
    ...
    it('应检测支持的 URL', () => {
      ...
      // online-game 类型由 YikeOnlineGameProvider 处理，YikeProvider 不处理
      expect(provider.canHandle('https://home.yikeweiqi.com/mobile.html#/online-game/72910281')).toBe(false);
